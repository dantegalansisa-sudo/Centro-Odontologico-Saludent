  ...
  return (
    <footer className="footer">
      <div className="section-container">
        ...
        >
          <div>
            <div className="footer__logo">CENTRO ODONTOLÓGICO SALUDENT</div>
          ...
          <div className="footer__social">
            <a href="https://instagram.com/saludentrd" className="footer__social-link interactive" aria-label="Instagram">

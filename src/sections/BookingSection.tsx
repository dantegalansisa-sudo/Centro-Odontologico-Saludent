...
const infoItems = [
  { icon: '📍', label: 'Dirección', value: 'Bolivar 169, esq Pasteur, Edif Pimae, Suite 102, Gascue' },
  { icon: '📞', label: 'Teléfono', value: '809-221-4226' },
  { icon: '⏰', label: 'Horario', value: 'Lun - Vie: 9:00 AM - 6:00 PM | Sáb: 9:00 AM - 2:00 PM' },
  { icon: '💬', label: 'WhatsApp', value: 'WhatsApp Directo' },
  { icon: '✉️', label: 'Instagram', value: '@saludentrd' },
];
...
export default function BookingSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    window.open('https://wa.me/18092214226', '_blank');
    setSent(true);

    ...
    <>
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
        <a href="/" className="navbar__logo" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <img src="/imagenes/saludent/logo.png" alt="Centro Odontológico Saludent" className="navbar__logo-img" style={{ height: '50px', width: 'auto' }} />
          <span style={{ fontFamily: 'var(--font-brutal)', fontSize: '13px', letterSpacing: '0.08em', color: 'var(--primary)', textTransform: 'uppercase', lineHeight: '1.2' }}>Saludent</span>
        </a>

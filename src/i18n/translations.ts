...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    // Hero
    'hero.tagline': 'Centro Odontológico en Gascue',
    'hero.title1': 'TU',
    'hero.title2': 'SONRISA',
    ...
    // Footer
    'footer.tagline': 'Centro Odontológico en Gascue',
    'footer.rights': '© 2026 Centro Odontológico Saludent. Todos los derechos reservados.',
  ...
  en: {
    ...
    // Hero
    'hero.tagline': 'Dental Center in Gascue',
    'hero.title1': 'YOUR',
    'hero.title2': 'SMILE',
    ...
    // Footer
    'footer.tagline': 'Dental Center in Gascue',
    'footer.rights': '© 2026 Centro Odontológico Saludent. All rights reserved.',

...
export const articles: Article[] = [
  {
    ...
    readTime: '4 min',
    img: '/imagenes/saludent/logo.png',
    content: [
      ...
      'En Centro Odontológico Saludent evaluamos cada caso de forma personalizada. Durante tu consulta, analizaremos el estado de tus dientes, tus expectativas y tu presupuesto para recomendarte el tratamiento que mejor se adapte a ti.',
    ],
    tips: [
  ...
  },
  {
    ...
    content: [
      ...
      'En Centro Odontológico Saludent utilizamos tecnología de diagnóstico 3D para planificar cada implante con precisión milimétrica, asegurando los mejores resultados posibles para cada paciente.',
    ],
    tips: [
  ...
  },
  {
    ...
    content: [
      ...
      'En Centro Odontológico Saludent creemos que la prevención es la mejor inversión en tu salud dental. Nuestro equipo está disponible para enseñarte las técnicas correctas y crear un plan de prevención personalizado.',
    ],
    tips: [
